...
const form = useForm({
    ...
    stage: props.curso.stage,
    description: props.curso.description,
    visible: props.curso.visible,
});

const submit = () => {
    form.put(route("cursos.update", props.curso.id));
};

</script>

<template>
    <Head title="Modificar Curso" />
    <AuthenticatedLayout>
            ...
            <div class="popch">
                ...
                <form @submit.prevent="submit" class="p-5">
                    ...
                    <div class="text-center mt-3">
                        <PrimaryButton type="submit">Modificar Curso</PrimaryButton>
                    </div>
                </form>
            </div>
        </div>
